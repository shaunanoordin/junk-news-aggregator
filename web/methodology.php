...
<main class="info-page">
  <div class="info-section">
    ...
    <section>
      <h3>About</h3>
      <p>
        The <a href="/news/app">Junk News Aggregator</a>, the <a href="index.php#visual_jna">Visual Junk News Aggregator</a> and the <a href="top10.php">Top 10 Junk News Aggregator</a> are research projects of the <a href="comprop.oii.ox.ac.uk">Computational Propaganda group (COMPROP)</a> of the <a href="www.oii.ox.ac.uk">Oxford Internet Institute (OII)</a> at the <a href="http://www.ox.ac.uk">University of Oxford</a>.
      </p>
      <p>
    ...
    <section>	
      ...
      <ol> 
        ...
        <li> For each junk news source website, the posts it uploaded on its public Facebook page are retrieved and displayed on the Junk News Aggregator every hour. The visual version and the Top 10 version display the most engaged-with posts of the last 24 hours, refreshing daily at 5pm ET.</li>
      </ol>
      <p>
        More details about the data collection, methodology, and how the aggregators work can be found in the sections on <a href="#full_method">Data Collection and Methodology</a>, <a href="#about_jna">About the Junk News Aggregator</a>, and <a href="#about_top10">About the Top-10 Junk News Aggregator</a>, below.
      </p>
    </section>
    ...
    <section id="full_method">	
      ...
      <ol> 
        ...
        <li> Using this expanded hashtag list, use the Twitter Streaming API to retrieve all English-language tweets (including retweets and quote tweets) mentioning any of these hashtags. This data collection resulted in 2,541,544 tweets posted in the period September 21 to September 30, 2018. </li>
